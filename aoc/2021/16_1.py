...
# that the length is a 15-bit number representing the number of bits in
# the sub-packets.
...
# that the length is a 11-bit number representing the number of sub-
# packets.
...
# packet that contains two literal values. This packet has a version sum
# of `*12*`.
...
test_input = """C0015000016115A2E0802F182340"""
