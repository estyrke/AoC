...
# to sink in. Fortunately, you brought a small deck of [space
...
# decks: `9` and `5`. Player 1 has the higher card, so both cards move
# to the bottom of player 1's deck such that `9` is above `5`. In total,
...
# multiplied by 1, the second-from-the-bottom card is worth the value of
# the card multiplied by 2, and so on. With 10 cards, the top card is
# worth the value on the card multiplied by 10. In this example, the
