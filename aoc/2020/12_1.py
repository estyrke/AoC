...
# [PA system](https://en.wikipedia.org/wiki/Public_address_system) to
# ask if anyone can help, you quickly volunteer.
#
...
# distance](https://en.wikipedia.org/wiki/Manhattan_distance) (sum of
