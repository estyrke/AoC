...
# *`14897079`*. (Transforming the subject number of `5764801` (the
# card's public key) with a loop size of `11` (the door's loop size)
...
def solve(inp: TextIOWrapper):
    ...
    card_pk, door_pk = [int(l.strip()) for l in inp.readlines()]
