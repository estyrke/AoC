...
position (`3`) is *at* position `3`, so it overwrites itself.
...
`50` respectively. Multiplying these produces `3500`; this is stored
at position `0`:
...
part1_test_input = """1,9,10,3,2,3,11,0,99,30,40,50"""

part1_test_output = 3500


def part1(inp: TextIOWrapper):
    opcodes = list(map(int, inp.readline().strip().split(",")))
...
def part2(inp: TextIOWrapper):
    memory = list(map(int, inp.readline().strip().split(",")))
